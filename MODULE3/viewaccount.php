                ...
                <nav class="navbar navbar-expand-lg navbar-light mu-navbar">
                  ...
                  <a class="navbar-brand mu-logo" href="index.php"><p id="firstname"><span><i>DROP IN</i></span></p></a>
                    ...
                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
                        <span class="fa fa-bars"></span><br/></span><br/>
                    </button>

                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul class="navbar-nav mr-auto mu-navbar-nav"><br/>
                                    ...
                                    <center>
                                        ...
                                        <article id="content"><div class="ic"></div>
                                            <div class="wrapper"><center>
                                                    ...
                                                    ?>                                      
                                                    <table width="30%">
                                                        <tr><td>Account Name:</td><td><?php echo "<font color='blue'>" . $row['name'] ?></td></tr>
                                                        <tr><td>Account Type:</td><td><?php echo "<font color='blue'>" . $row['acctype'] ?></td></tr>
                                                        <tr><td>Account No:</td><td><?php echo "<font color='blue'>" . $row['accno'] ?></td></tr>
                                                        <tr><td>Account Balance:</td><td><?php echo "<font color='blue'>" . $r['bal'] ?></td></tr>
                                                    </table>
                                                    <form method="post" action="">
                                                        <br/> <input type="submit" name="viewtransaction" value="View transactions"/>&nbsp;<span class="glyphicon glyphicon-refresh"></span>
                                                    </form>

                                                    <?php
                                                    if (isset($_REQUEST['viewtransaction'])) {
                                                        $queryt = "Select * from logintime where email='{$_SESSION['id']}'";
                                                        $resultt = mysql_query($queryt);
                                                        $rowt = mysql_fetch_assoc($resultt);
                                                        date_default_timezone_set('Asia/Kolkata');
                                                        ...
                                                        echo "<script>window.location.href='viewaccount.php?accno={$row['accno']}&code={$row['bcode']}'</script>";
                                                    }
                                                    if (isset($_GET['accno'])) {
                                                        $query = "select * from tbltransaction where bcode='{$_GET['code']}' and accno='{$_GET['accno']}' order by slno";
                                                        $result = mysql_query($query);
                                                        if (mysql_num_rows($result) > 0) {
                                                            ...
                                                            <br/><br/><table>
                                                                ...
                                                                while ($row = mysql_fetch_assoc($result)) {
                                                                    ?>
                                                                    <tr><td align="center"><?php echo "<font color='#4299DA'>" . $row['dtdate'] ?></td>
                                                                        <td align="center"><?php echo "<font color='#4299DA'>" . $row['discp'] ?></td>
                                                                        <td align="right"><?php echo $row['cedit'] ?></td>
                                                                        <td align="right"><?php echo $row['debit'] ?></td>
                                                                        <td align="right"><?php echo "<font color='blue'>" . $row['bal'] ?></td></tr>         
                                                                    <?php
                                                                }
                                                                echo "</table>";
                                                            } else {
